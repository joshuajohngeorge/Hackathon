    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            {user ? (
              <Link
                href="/dashboard"
                className="flex items-center gap-1.5 text-sm font-medium text-white bg-green-600 hover:bg-green-700 hover:shadow-md hover:shadow-green-600/20 hover:-translate-y-0.5 px-4 py-2 rounded-full transition-all duration-300"
              >
                Dashboard
              </Link>
            ) : (
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="mt-8 flex items-center gap-3">
              <Link
                href={primaryHref}
                className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-medium px-6 py-3 rounded-xl shadow-md shadow-green-600/20 hover:shadow-lg hover:shadow-green-600/40 hover:-translate-y-0.5 transition-all duration-300"
              >
                Check your lease
              ...
              <Link
                href="/compare"
                className="flex items-center gap-2 bg-white border border-gray-200 text-gray-700 hover:border-gray-300 hover:bg-gray-50 hover:shadow-md hover:shadow-gray-200/50 hover:-translate-y-0.5 font-medium px-6 py-3 rounded-xl transition-all duration-300"
              >
          ...
          <div className="space-y-4">
            <Link
              href="/analyze"
              className="block group bg-white rounded-3xl border border-gray-100 p-5 shadow-xl shadow-gray-200/40 hover:shadow-2xl hover:shadow-green-900/10 hover:-translate-y-1 transition-all duration-300"
            >
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="font-semibold text-gray-900">Lease Checker</h3>
                </div>
                <ArrowRight className="w-4 h-4 text-gray-300 group-hover:text-green-500 group-hover:translate-x-0.5 transition-all shrink-0" />
              </div>
              <p className="text-sm text-gray-500 leading-relaxed mb-3">
                Upload your lease. We scan for auto-renewal traps, vague maintenance clauses, and hidden fees.
              </p>
            </Link>
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="font-semibold text-gray-900">Rent Fairness</h3>
                </div>
                <ArrowRight className="w-4 h-4 text-gray-300 group-hover:text-green-500 group-hover:translate-x-0.5 transition-all shrink-0" />
              </div>
              <p className="text-sm text-gray-500 leading-relaxed mb-3">
                Get an instant fairness verdict benchmarked against real C-U market rates.
              </p>
            </Link>
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="font-semibold text-gray-900">Dispute Assistant</h3>
                </div>
                <ArrowRight className="w-4 h-4 text-gray-300 group-hover:text-green-500 group-hover:translate-x-0.5 transition-all shrink-0" />
              </div>
              <p className="text-sm text-gray-500 leading-relaxed">
                Get help disputing any lease issue. Grounded in Illinois law and norms.
              </p>
            </Link>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                body: "Our system scans for dozens of known red flags, unusual fees, and rights violations.",
              },
              {
                num: "03",
                icon: MessageSquare,
              ...
              <div
                key={step.num}
                className="bg-white rounded-3xl border border-gray-100 shadow-xl shadow-gray-200/40 p-7 hover:-translate-y-1 hover:shadow-2xl hover:shadow-green-900/10 transition-all duration-300"
              >
      ...
      <footer className="bg-green-50/40">
        <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <img src="/beaver.png" alt="Lease Beaver" className="h-12 w-auto object-contain" />
          </div>
